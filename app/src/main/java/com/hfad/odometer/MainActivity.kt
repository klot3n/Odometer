...
//                    val name: CharSequence = "my_channel_03"
...
//    }
    ...
    override fun onStart() {
        super.onStart()
//        if (ContextCompat.checkSelfPermission(this, OdometerService.PERMISSION_STRING)//().PERMISSION_STRING)
    ...
    private fun displayDistance() {
        ...
        handler.post(object : Runnable {
            override fun run() {
                ...
                if (odometer != null && bound) {
                    distance = odometer?.getDistance() ?: 0.0
                    location = odometer?.getLocation()
                }

                location_view.text = location.toString()
                distance_view.text =
